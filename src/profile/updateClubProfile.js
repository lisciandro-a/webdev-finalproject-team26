...
function UpdateClubProfile ({setEdit}) {
        ...
        <form onSubmit={(e) => updateProfile(e)} className="px-3">
          <div className="d-flex justify-content-center flex-wrap gap-3">
            <div className="flex-fill">
              <label htmlFor="update-orgName" className="py-1">Org name</label>
              <input 
                id="update-orgName"
          ...
          <div className="py-2">
            <h5>Virutal Meetings</h5>
            <div className="flex-fill">
                <label htmlFor="update-link-virtual-meeting" className="py-1">Link</label>
                <input 
                id="update-link-virtual-meeting"
                className="form-control" 
                defaultValue={profile?.virtualMeetings?.link}
                onChange={(e) => {
                  setUpdatedProfile({
                    ...updatedProfile,
                    virtualMeetings: {
              ...
              ></input>
              <label htmlFor="update-weekday-virtual-meeting" className="py-1">Weekday</label>
                <input 
                id="update-weekday-virtual-meeting"
                className="form-control" 
                defaultValue={profile?.virtualMeetings?.meetingWeekday}
                onChange={(e) => {
                  setUpdatedProfile({
                    ...updatedProfile,
                    virtualMeetings: {
              ...
              ></input>
              <label htmlFor="update-time-virtual-meeting" className="py-1">Time</label>
                <input 
                id="update-time-virtual-meeting"
                className="form-control" 
                defaultValue={profile?.virtualMeetings?.meetingTime}
                onChange={(e) => {
                  setUpdatedProfile({
                    ...updatedProfile,
                    virtualMeetings: {
